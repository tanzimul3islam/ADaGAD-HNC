...
- [ ] **Datasets** — Amazon, YelpHotel, YelpNYC, YelpRes with 5 random seeds.
...
"Removing any single branch degrades performance (Table 4). Notably, the reconstruction branch is the most critical on dense feature graphs (Amazon), whereas the patch branch contributes most on review networks (YelpHotel and YelpRes). This validates our multi-objective design."
...
- `results_table.md`, `results_table.tex` — main result table (Amazon / YelpHotel / YelpNYC / YelpRes)
